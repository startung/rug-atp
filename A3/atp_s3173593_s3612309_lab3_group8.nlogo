...
[
  ...
  has-been-infected?  ;; whether the turtle has been infected at any point in time
]
...
<experiments>
  <experiment name="experiment" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>unique-infections</metric>
    ...
    <steppedValueSet variable="virus-spread-chance" first="0.1" step="0.1" last="6"/>
